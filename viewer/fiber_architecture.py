...
class FiberArchitectureMixin:
    ...
    def draw_fiber_architecture(self):
        ...
        if getattr(self, '_fiber_draw_dirty', False) or not hasattr(self, '_fiber_draw_pts'):
    ...
    def _draw_fiber_architecture_slow(self, alpha, level_prog, highlight_stream):
        ...
        # (Contour outlines at other levels intentionally not drawn —
        #  the cyan line strip + points above is sufficient)
