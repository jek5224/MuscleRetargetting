...
install_pydart dart https://github.com/dartsim/dart v6.11.2 \
    "-DDART_ENABLE_SIMD=ON -DFCL_INCLUDE_DIRS=$ENVDIR/include/fcl -DBULLET_INCLUDE_DIRS=$ENVDIR/include/bullet -DDART_BUILD_DARTPY=ON -DCMAKE_BUILD_TYPE=Release"
