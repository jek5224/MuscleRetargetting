...
CHECKPOINT_DIR = "volume_distill/walk_v1dec_v3_checkpoints"
LOG_DIR = "volume_distill/walk_v1dec_v3_runs"
...
def train():
    ...
    print(f"\nTrain: {n_total} samples (full-batch), {len(muscle_names)} muscles, "
          f"{pair_i.shape[0]} adjacent pairs, lambda={TEMPORAL_LAMBDA}")
    ...
    for epoch in range(start_epoch + 1, end_epoch + 1):
        ...
        loss = data_loss + TEMPORAL_LAMBDA * delta_loss
